 ...
 * Returns only events created by this admin (super admin: createdBy IS NULL; others: createdBy = adminId).
 */
...
/**
 * GET /api/admin/sales
 * Returns all sales (orders) for events created by this admin only.
 */
